...
// the bundle loads. build-info.json is regenerated by the prepublish hook, and
// the class count is derived, so neither has to be remembered at publish time.
const buildStamp = [
  `EASA_Extensions_SORA v${componentConfig.version}`,
  buildInfo.dirty ? `${buildInfo.commit} (dirty)` : buildInfo.commit,
  `built ${buildInfo.builtAt}`,
  `${landuseHistogramCodes.length} land use classes`,
].join(' · ');

// eslint-disable-next-line no-console
console.info(buildStamp);
