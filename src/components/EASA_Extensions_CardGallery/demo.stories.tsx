...
import { EasaExtensionsCardGallery } from './index';
...
export default {
  ...
  component: EasaExtensionsCardGallery
};
        ...
        createComponent: (meta: any) => {
          ...
          return (
            <Details highlightedData={highlightedData}>
              <FieldValueItem key='Description' name='Description' value={tasks[0].pyDescription} />
              <FieldValueItem
                key='Assigned To'
                name='Assigned To'
                value={tasks[0].pxCreateOpName}
              />
              <FieldValueItem
                key='Due date'
                name='Due date'
                value={<DateTimeDisplay variant='date' value={tasks[0].pyDueDate} />}
              />
            </Details>
          );
        }
...
type Story = StoryObj<typeof EasaExtensionsCardGallery>;
export const Default: Story = {
  render: args => {
    ...
    return <EasaExtensionsCardGallery {...props} />;
  },
  args: {
